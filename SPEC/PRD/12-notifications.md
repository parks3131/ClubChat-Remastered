...
| **Message reported** | A member reports a message | **Whoever reviews reports in that channel**: the space's admins, or - for a DM, which has none - platform moderators. Never the reporter, and never the reported member | The Reports tab for that channel, or the platform queue | Inbox is opened |
