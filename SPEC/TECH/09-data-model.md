...
meetup_nudges         id, club_id, meetup_id, actor_id, created_at, cooldown_until
                      ...
                      -- ONE NUDGE PER MEETUP PER HOUR (ADR-0031, superseding ADR-0030's
                      -- per-club rule), and the constraint is the rule -
                      ...
                      -- meetup_id is nullable and SET NULL, and a NULL operand takes a row
                      -- OUT of an exclusion constraint - which is what this wants: a nudge
                      -- whose meetup is deleted blocks nothing, because there is no meetup
                      -- left to nudge. Exactly inverted from what ADR-0030 needed.
